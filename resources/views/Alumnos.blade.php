            ...
            <tr class="item{{$item->nua}}">
                ...
                <td>
                    <button class="edit-modal btn btn-info"
                            data-info="{{$item->nua}},{{$item->cveesp}},{{$item->email}},{{$item->semestre}}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        <label class="control-label col-sm-2" for="cveesp">cve esp</label>
                        <div class="col-sm-10">
                            <input type="name" class="form-control" id="cveesp">
                        </div>
                    </div>
...
<script>
    ...
    function fillmodalData(details){
        $('#fid').val(details[0]);
        $('#cveesp').val(details[1]);
        $('#email').val(details[2]);
        $('#semestre').val(details[3]);
    }
