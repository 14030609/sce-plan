...
<div class="container ">
    ...
    <div class="table-responsive text-center">
        <table class="table table-borderless" id="table">
            <thead>
            <tr>
                <th class="text-center">cveesp</th>
            ...
            <tr class="item{{$item->cveesp }}">
                ...
                <td>
                    <button class="edit-modal btn btn-info"
                            data-info="{{$item->cveesp}},{{$item->cvemat}}">
            ...
            <div class="modal-body">
                <form class="form-horizontal" role="form">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type=hidden class="form-control" id="cveesp" >
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                {!! Form::label('full_name', 'Rol') !!}
                                <select class="form-control"  id="cvemat">
            ...
            success: function(data) {
                if (data.errors){
                    ...
                    $('.item' + data.id).replaceWith("<tr class='item" + data.id + "'><td>" +
                        ...
                        data.id+
                        ","+data.cvemat+"'><span class='glyphicon glyphicon-edit'></span> Edit</button> <button class='delete-modal btn btn-danger' data-info='"
                        + data.id+","+data.cvemat+"' ><span class='glyphicon glyphicon-trash'></span> Delete</button></td></tr>");
